...
export default function CheckoutPage() {
  ...
  const confirmCodOrder = async () => {
    try {
      const res = await axiosPrivate.post("user/create-order/", {
        payment_method: "cod",
        address,
      });
  ...
  const delivery = isFreeDelivery
    ? 0
    : checkoutItems.reduce((s, i) => s + Number(i.delivery_charge) * i.qty, 0);
    ...
    return (
      <div className="min-h-screen bg-[#f0fdfb] flex items-center justify-center">
        <div className="text-center text-gray-400">
          ...
          <button
            className="mt-2 px-7 py-3 rounded-xl 
bg-gradient-to-br from-teal-600 to-teal-400 
text-white font-semibold text-[15px] 
shadow-[0_4px_16px_rgba(13,148,136,0.28)] 
  ...
  const steps = [
    {
      num: 1,
      label: "Account",
      icon: <img src="/icons/filledcheck.png" alt="User" />,
    },
    {
      num: 2,
      label: "Address",
      icon: <img src="/icons/location.png" alt="Map Pin" />,
    },
    {
      num: 3,
      label: "Payment",
      icon: <img src="/icons/wallet.png" alt="Credit Card" />,
    },
  ];
            ...
            {steps.map((s, idx) => (
              ...
              >
                <div className="flex flex-col items-center gap-1">
                  ...
                  >
                    {step > s.num ? (
                      <img src="/icons/filledcheck.png" alt="Check" />
                    ) : (
                      s.icon
                    )}
                  </div>
                  <span
                    style={{
                      fontSize: "11px",
                      fontWeight: 600,
                      color: step >= s.num ? "#0d9488" : "#94a3b8",
                    }}
                  >
                    {s.label}
                  </span>
                ...
                {idx < steps.length - 1 && (
                  <div
                    className={`co-step-connector ${step > s.num ? "done" : ""}`}
                    style={{ margin: "0 8px", marginBottom: "18px" }}
                  />
                )}
              </div>
            ))}
            ...
            <div className="flex-1 co-card p-6 lg:p-8 co-animate">
              ...
              {step === 1 && (
                <div className="text-center py-8">
                  ...
                  <button
                    className="co-btn-primary w-max mx-auto"
                    onClick={() => {
                      setShowAuth(true);
              ...
              {step === 2 && (
                <div>
                  ...
                  <button
                    className="co-btn-primary w-full mt-6"
                    onClick={saveAddress}
                    style={{ width: "100%" }}
                  >
              ...
              {step === 3 && (
                <div>
                  ...
                  >
                    {/* Prepaid */}
                    <div
                      className={`co-radio-card ${paymentMethod === "prepaid" ? "selected" : ""}`}
                      onClick={() => setPaymentMethod("prepaid")}
                    >
                      <div
                        className={`co-radio-dot ${paymentMethod === "prepaid" ? "selected" : ""}`}
                      >
                        {paymentMethod === "prepaid" && (
                          <div className="co-radio-dot-inner" />
                        )}
                      </div>
                      <div style={{ flex: 1 }}>
                        <p
                    ...
                    {/* COD */}
                    <div
                      className={`co-radio-card ${paymentMethod === "cod" ? "selected" : ""}`}
                      onClick={() => setPaymentMethod("cod")}
                    >
                      <div
                        className={`co-radio-dot ${paymentMethod === "cod" ? "selected" : ""}`}
                      >
                        {paymentMethod === "cod" && (
                          <div className="co-radio-dot-inner" />
                        )}
                ...
                <div className="co-card p-5">
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          >
                            ...
                            {Number(item.mrp) > Number(item.price) && (
                              ...
                              >
                                ₹{(Number(item.mrp) * item.qty).toFixed(0)}
                              </span>
                            )}
                          </div>
                        </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        style={{
                          color: delivery === 0 ? "#16a34a" : "#64748b",
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 14, color: "#64748b", margin: 0 }}>
            You'll pay{" "}
            <strong style={{ color: "#0d9488" }}>₹{total.toFixed(0)}</strong>{" "}
