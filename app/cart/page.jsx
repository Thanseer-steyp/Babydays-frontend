  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-6" style={{ fontFamily: "'Nunito', sans-serif" }}>
        <div className="text-6xl"><img src="/icons/cart.png" alt="cart" className="w-32 h-32" /></div>
        <h2 className="text-2xl font-black text-gray-800">Sign in to view your cart</h2>
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 flex flex-col items-center justify-center py-24 gap-4">
            <div className="text-7xl"><img src="/icons/cart.png" alt="cart" className="w-32 h-32" /></div>
            <h3 className="text-xl font-black text-gray-700">Your cart is empty</h3>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-3 flex-wrap gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="font-black text-gray-900">₹{Number(item.price).toLocaleString("en-IN")}</span>
                        {item.mrp > item.price && (
                          <span className="text-sm text-gray-400 line-through">₹{Number(item.mrp).toLocaleString("en-IN")}</span>
                        )}
                      </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl border border-teal-400 p-6 sticky top-24">
                ...
                <div className="flex flex-col gap-3 text-sm">
                  ...
                  <div className="flex justify-between text-gray-600">
                    <span>Delivery</span>
                    <span className={deliveryCharge === 0 ? "font-bold text-green-600" : "font-semibold"}>
                ...
                <Link href="/products" className="block text-center text-sm font-bold text-teal-600 hover:text-teal-700 mt-4">
                  Continue Shopping
                </Link>
              </div>
            </div>
